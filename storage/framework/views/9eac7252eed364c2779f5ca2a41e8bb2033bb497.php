      ...
      <?php $__currentLoopData = $participationsAcceptes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            ...
            <tr>    
              ...
              <td><?php echo e($participation->Contribution); ?> </td>
                <td><?php echo e($participation->EventID); ?> </td> 
             </tr> 
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\safyo\Desktop\Projet_PHP_Laravel\Projet_TeamGift\TeamGift\resources\views/listeparticipationAccepter.blade.php ENDPATH**/ ?>